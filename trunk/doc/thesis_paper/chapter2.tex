...
%can now move onto talking about 3D vis and showing images of that.  Explaining benefits of 3D vis.  able to better see the contours of the terrain.  visual objstructions become more apparent.  can better analyze movement patterns with movement graphs, etc.
