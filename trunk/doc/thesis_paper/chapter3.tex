...
\begin{figure*}[htp]
\begin{center}
%\includegraphics[width=3.3in]{images/citation_graph_node_drop_off.eps}
%\includegraphics[width=3.3in]{images/inet4500_node_drop_off.eps}
 \scalebox
 {0.80} % h_length
 {
 \includegraphics{images/citation_graph_node_drop_off.eps}
% \includegraphics{images/citation_graph_node_drop_off.pdf}
 }
...
% \includegraphics{images/inet4500_node_drop_off.pdf}
 }
\end{center}
