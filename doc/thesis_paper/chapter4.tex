...
Further exploration of other, more advanced, spectrum sensing, such as cooperative energy detection, techniques would prove to be an interesting study.  We also want to expand the use of our algorithms to a real cognitive radio testbed to see how well the GPU can handle live input and output in a real cognitive radio environment.
